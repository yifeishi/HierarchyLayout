...
def main():
    ...
    sys.stdout.flush()
    read_path, box_sizes, obbs, gts, write_path, feature_path, len = data_utils.read_test_path(args.path)
    ...
    with tf.Session() as sess:
        ...
        for batch_idx_train in range(batch_num_per_epoch):
            ...
            cloud_feature,cloud_prob = sess.run([feature,probs], feed_dict={
