...
def get_args():
    ...
    parser.add_argument('--scene_list_path', type=str, default='test_scene_list_path')
    parser.add_argument('--save_path', type=str, default='models')
    parser.add_argument('--nick_name', type=str, default='')
    parser.add_argument('--resume_snapshot', type=str, default='')
    parser.add_argument('--pretrained_model', type=str, default='./models/snapshots_2019-04-04_15-09-06_/encoder_decoder_model_epoch_260_loss_0.0659.pkl')
